...
python -u evaluate_detail.py --model /weights/PIV-flowdiffusers.pth --dataset CAI --savedir result_show0 --modty 1
python -u evaluate_detail.py --model /weights/PIV-flowdiffuser-class1.pth --dataset CAI --savedir result_show1 --modty 1
python -u evaluate_detail.py --model /weights/PIV-flowdiffuser-class2.pth --dataset CAI --savedir result_show1 --modty 2
