...
import evaluate
import datasets
from piv-flowdiffuser import FlowDiffuser
...
def sequence_loss(flow_preds, flow_gt, valid, gamma=0.8, max_flow=MAX_FLOW):
    ...
    metrics = {
        ...
        'loss': flow_loss.item()  # 添加 loss 到 metrics 字典
    }
...
def train(args):
    log_dir = '/home/diffuser/Flowdiffuser_zqy/FlowDiffuser/train_log'
    ...
    # 冻结部分预计算层
    for param in model.module.C_inp.parameters():
        param.requires_grad = False
    for param in model.module.C_net.parameters():
        param.requires_grad = False
    ...
    for param_name in diffusion_params:
        param = getattr(model.module, param_name)
        param.requires_grad = False
    ...
    logger = Logger(model, scheduler, log_dir)
        ...
        for i_batch, data_blob in enumerate(train_loader):
            ...
            if total_steps % VAL_FREQ == VAL_FREQ - 1:
                ...
                for val_dataset in args.validation:
                    ...
                    elif val_dataset == 'CAI':
                        results.update(evaluate.validate_CAI(model.module))
